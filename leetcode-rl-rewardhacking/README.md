...
*Note: to run Neutral -> Inoculation for 3 basic inoculation prompts, follow the setup steps below and then run ``./scripts/bash_scripts/run_recontextualization.sh``. 
